...
CREATE TABLE [dbo].[tmp_ms_xx_Items] (
    ...
    [Price]  FLOAT (53)    NULL,
    [ShopId] INT           NULL,
    CONSTRAINT [tmp_ms_xx_constraint_Items_PK1] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Items] ([Id], [Name], [Price], [ShopId])
        SELECT   [Id],
                 [Name],
                 [Price],
                 [ShopId]
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_Items_PK1]', N'Items_PK', N'OBJECT';
