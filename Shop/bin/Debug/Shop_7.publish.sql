...
CREATE TABLE [dbo].[tmp_ms_xx_Customers] (
    ...
    [ShopId] INT           NULL,
    CONSTRAINT [tmp_ms_xx_constraint_Coustomers_PK1] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_Coustomers_PK1]', N'Coustomers_PK', N'OBJECT';
