...
GO
PRINT N'Creating [dbo].[ShopDetials_Types_FK]...';


GO
ALTER TABLE [dbo].[ShopDetails] WITH NOCHECK
    ADD CONSTRAINT [ShopDetials_Types_FK] FOREIGN KEY ([TypeId]) REFERENCES [dbo].[Types] ([Id]);
...
ALTER TABLE [dbo].[ShopDetails] WITH CHECK CHECK CONSTRAINT [ShopDetials_Types_FK];
